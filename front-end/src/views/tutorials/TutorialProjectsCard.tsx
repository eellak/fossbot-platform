...
const TutorialProjectsCard = () => {
  ...
  return (
    <PageContainer>
      <DashboardCard
        title={t('tutorial-projects-card.card-title')}
        subtitle={t('tutorial-projects-card.subtitle')}
        action={
            ...
            >
                ...
                <TableRow>
                  <TableCell>
                    <Typography variant="subtitle2" fontWeight={600}>
                      {t('tutorial-projects-card.type')}
                    </Typography>
                  </TableCell>
                  <TableCell>
                    <Typography variant="subtitle2" fontWeight={600}>
                      {t('tutorial-projects-card.title')}
                    </Typography>
                  </TableCell>
                  <TableCell>
                    <Typography variant="subtitle2" fontWeight={600}>
                      {t('tutorial-projects-card.description')}
                    </Typography>
                  </TableCell>
                  {/* <TableCell>
                  <Typography variant="subtitle2" fontWeight={600}>
                  ...
                  <TableCell align="center">
                    <Typography variant="subtitle2" fontWeight={600}>
                      {t('tutorial-projects-card.edit')}
                    </Typography>
                  </TableCell>
                  <TableCell align="center">
                    <Typography variant="subtitle2" fontWeight={600}>
                      {t('tutorial-projects-card.delete')}
                    </Typography>
                  </TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {projects.length === 0 ? (
                  <TableRow>
                    <TableCell>
                      <Typography>{t('tutorial-projects-card.noProjectsFound')} </Typography>
                    </TableCell>
                  </TableRow>
                ) : (
