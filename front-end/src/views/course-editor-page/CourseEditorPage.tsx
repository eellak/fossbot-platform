...
export default function CourseEditorPage() {
  ...
  return (
    <Box sx={{ minHeight: 'calc(100vh - 70px)', display: 'flex', flexDirection: 'column', bgcolor: 'background.default', '& .MuiButton-containedPrimary': { color: theme.palette.getContrastText(theme.palette.primary.main) }, '& .MuiButtonBase-root': { minHeight: 44 }, '& .MuiIconButton-root': { minWidth: 44 }, '& .MuiButtonBase-root:focus-visible': { outline: '2px solid', outlineColor: 'text.primary', outlineOffset: 2 } }}>
      ...
      <Dialog open={previewOpen} onClose={() => setPreviewOpen(false)} fullScreen>{selectedLesson && <LessonPreview course={course} initialLessonId={selectedLesson.id} token={token} onClose={() => setPreviewOpen(false)} />}</Dialog>
