...
const AuthProvider = ({ children }: AuthProviderProps) => {
  ...
  const loginAction = async (data: LoginData): Promise<LoginResponse> => {
    try {
      ...
      return {
        success: false,
        detail: errorMessage(err, 'Could not reach the platform API. Check that the backend is running.'),
      };
    }
  };
