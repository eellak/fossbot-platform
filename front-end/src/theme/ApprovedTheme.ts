...
export function approvedThemeOptions(dark: boolean): ThemeOptions {
  return {
    ...
    palette: {
      ...
      secondary: { main: dark ? '#a6b9d2' : '#485b75', light: dark ? '#253247' : '#edf1f6', contrastText: dark ? '#14213b' : '#ffffff' },
      ...
      info: { main: dark ? '#a2c5ff' : '#315b91', light: dark ? '#23364d' : '#eef4fb', contrastText: dark ? '#14213b' : '#ffffff' },
