  ...
  return (
    <Box aria-live="polite" sx={{ height: '100%', minHeight: 0, display: 'flex', flexDirection: 'column' }}>
      <Stack direction="row" spacing={1} alignItems="center" flexWrap="wrap" sx={{ gap: 1 }}>
        ...
        <Button startIcon={<IconPlayerStop size={18} />} onClick={() => { stopRef.current?.(); stopMotion(); endSensorRun(); }}>{t('education.workspace.stop')}</Button>
