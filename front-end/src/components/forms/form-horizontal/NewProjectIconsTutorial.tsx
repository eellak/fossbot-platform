      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={9}>
          <CustomOutlinedInput
            ...
            placeholder={t('tutorial-project-form.giveYourProjectAName')}
            fullWidth
        ...
        <Grid item xs={12} sm={9}>
          <CustomOutlinedInput
            ...
            placeholder={t('tutorial-project-form.describeYourProject')}
            fullWidth
...
export default NewProjectIconsTutorial;
